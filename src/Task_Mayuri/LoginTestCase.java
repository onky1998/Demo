...
public class LoginTestCase {
	...
	public void LoginTest() throws InterruptedException{
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@name=\"name\"]")).sendKeys("Onkar");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@name=\"mobile\"]")).sendKeys("8668366960");
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//input[@name=\"email\"]")).sendKeys("onkar.vannal25@gmail.com");
		Thread.sleep(3000);
		...
		SC3.selectByVisibleText("February");
		Thread.sleep(3000);
